...
public static class FExtensions {
    ...
    public static void Move2      (this Transform  t, Vector2 p          ) { t.position                = new Vector3(p.x,                         p.y,                         t.position.z                ); }
    public static void Move2      (this Transform  t, float   x, float y ) { t.position                = new Vector3(x,                           y,                           t.position.z                ); }
    public static void Move2      (this Component  c, Vector2 p          ) { c.transform.position      = new Vector3(p.x,                         p.y,                         c.transform.position.z      ); }
    public static void Move2      (this Component  c, float   x, float y ) { c.transform.position      = new Vector3(x,                           y,                           c.transform.position.z      ); }
    public static void Move2      (this GameObject g, Vector2 p          ) { g.transform.position      = new Vector3(p.x,                         p.y,                         g.transform.position.z      ); }
    public static void Move2      (this GameObject g, float   x, float y ) { g.transform.position      = new Vector3(x,                           y,                           g.transform.position.z      ); }
    public static void Move2Local (this Transform  t, Vector2 p          ) { t.localPosition           = new Vector3(p.x,                         p.y,                         t.localPosition.z           ); }
    public static void Move2Local (this Transform  t, float   x, float y ) { t.localPosition           = new Vector3(x,                           y,                           t.localPosition.z           ); }
    public static void Move2Local (this Component  c, Vector2 p          ) { c.transform.localPosition = new Vector3(p.x,                         p.y,                         c.transform.localPosition.z ); }
    public static void Move2Local (this Component  c, float   x, float y ) { c.transform.localPosition = new Vector3(x,                           y,                           c.transform.localPosition.z ); }
    public static void Move2Local (this GameObject g, Vector2 p          ) { g.transform.localPosition = new Vector3(p.x,                         p.y,                         g.transform.localPosition.z ); }
    public static void Move2Local (this GameObject g, float   x, float y ) { g.transform.localPosition = new Vector3(x,                           y,                           g.transform.localPosition.z ); }

    // 2D scaling.
    public static void Scale2 (this Transform  t, float   s            ) { t.localScale           = new Vector3(s,   s,   t.localScale.z           ); }
    public static void Scale2 (this GameObject g, float   s            ) { g.transform.localScale = new Vector3(s,   s,   g.transform.localScale.z ); }
    public static void Scale2 (this Component  c, float   s            ) { c.transform.localScale = new Vector3(s,   s,   c.transform.localScale.z ); }
    public static void Scale2 (this Transform  t, Vector2 s            ) { t.localScale           = new Vector3(s.x, s.y, t.localScale.z           ); }
    public static void Scale2 (this GameObject g, Vector2 s            ) { g.transform.localScale = new Vector3(s.x, s.y, g.transform.localScale.z ); }
    public static void Scale2 (this Component  c, Vector2 s            ) { c.transform.localScale = new Vector3(s.x, s.y, c.transform.localScale.z ); }
    public static void Scale2 (this Transform  t, float   sx, float sy ) { t.localScale           = new Vector3(sx,  sy,  t.localScale.z           ); }
    public static void Scale2 (this GameObject g, float   sx, float sy ) { g.transform.localScale = new Vector3(sx,  sy,  g.transform.localScale.z ); }
    public static void Scale2 (this Component  c, float   sx, float sy ) { c.transform.localScale = new Vector3(sx,  sy,  c.transform.localScale.z ); }
